      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="h-12 border-border bg-secondary pl-12 text-base text-foreground placeholder:text-muted-foreground rounded-xl"
          />
        </div>
        <Select value={statusFilter} onValueChange={setStatusFilter}>
          <SelectTrigger className="w-full h-12 border-border bg-secondary text-foreground sm:w-44 rounded-xl">
