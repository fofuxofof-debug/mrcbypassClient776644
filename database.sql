CREATE DATABASE IF NOT EXISTS mrcClient_panel;
USE mrcClient_panel;
...
CREATE TABLE IF NOT EXISTS license_keys (
  ...
  duration_seconds BIGINT DEFAULT 2592000,
...
VALUES (UUID(), 'mrcClient-TEST-KEY-1234-5678', 'Test Key', 1, 'active', DATE_ADD(NOW(), INTERVAL 30 DAY));
